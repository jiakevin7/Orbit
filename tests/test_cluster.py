...
class ClusterTests(unittest.TestCase):
    ...
    def test_token_budget_eviction_removes_oldest_prefixes(self):
        cluster = Cluster(cluster_id='cluster-a', config=ClusterConfig(cache_capacity=8, cache_capacity_tokens=5))
