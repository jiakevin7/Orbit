...
class CalibrationTests(unittest.TestCase):
    def test_fit_router_config_can_calibrate_reuse_before_latency(self) -> None:
    ...
    def test_fit_router_config_recovers_latency_coefficients_from_records(self) -> None:
    ...
    def test_fit_router_config_skips_when_too_few_records_are_available(self) -> None:
        base_config = RouterConfig()
        records = [
            ExecutionRecord(
                request_id="req-0",
